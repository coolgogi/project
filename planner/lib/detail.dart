...
class ChatButton extends StatefulWidget {
  ...
  ChatButton(this.snapshot, this.auth);
  @override
  _ChatButtonState createState() => _ChatButtonState(snapshot, auth);
}
...
class _ChatButtonState extends State<ChatButton> {
  ...
  _ChatButtonState(this.snapshot, this.auth);
  @override
  Widget build(BuildContext context) {
